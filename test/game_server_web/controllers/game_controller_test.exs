defmodule GameServerWeb.GameControllerTest do
  use GameServerWeb.ConnCase

  alias GameServer.Discovery

  @create_attrs %{name: "some name", type: "some type", uuid: "7488a646-e31f-11e4-aace-600308960662"}
  ...
  def fixture(:game) do
    {:ok, game} = Discovery.create_game(@create_attrs)
    game
  end
